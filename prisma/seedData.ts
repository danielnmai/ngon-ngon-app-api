...
export const foods: FoodWithOptions[] = [
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/bun-dau-mam-tom-1.jpeg",
		],
		options: [
			{
				id: 1,
			...
			},
			{
				...
				updatedAt: new Date(),
				foodId: 1,
				stripePriceId: "price_1S3nHpKA1oovtT3ZXuuEoEO4",
			},
		],
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/mi-xao-hai-san-1.jpeg",
		],
		options: [
			{
				id: 4,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/goi-tien-vua-1.jpeg",
		],
		options: [
			{
				id: 6,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/banh-mi-xiu-mai-1.jpeg",
		],
		options: [
			{
				id: 8,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/nui-xao-bo-1.jpeg",
		],
		options: [
			{
				id: 9,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/canh-ga-nuoc-mam-1.jpeg",
		],
		options: [
			{
				id: 11,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/canh-ga-ro-ti-1.jpeg",
		],
		options: [
			{
				id: 13,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/cha-gio-chay.jpeg",
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/cha-gio-chay-1.jpeg",
		],
		options: [
			{
				id: 15,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/cha-gio-man.jpeg",
		],
		options: [
			{
				id: 16,
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/bi-cuon-chay-1.jpeg",
		],
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/tom-chien-xu-1.jpeg",
		],
	...
	},
	{
		...
		updatedAt: new Date(),
		photos: [
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/bap-xao.jpeg",
			"https://ngon-ngon-app.s3.us-east-1.amazonaws.com/photos/bap-xao-1.jpeg",
		],
